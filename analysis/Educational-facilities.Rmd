...
It's also possible to embed an entire Shiny application within an R Markdown document using the `shinyAppDir` function. This example embeds a [Shiny application](https://aowusuda.shinyapps.io/Step_up_education_in_Ghana/) located in another directory:
